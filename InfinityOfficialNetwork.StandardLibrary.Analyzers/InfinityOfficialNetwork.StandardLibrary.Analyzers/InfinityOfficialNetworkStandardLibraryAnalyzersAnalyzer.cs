...
public class InfinityOfficialNetworkStandardLibraryAnalyzersAnalyzer : DiagnosticAnalyzer
{
	public const string DiagnosticId = "InfinityOfficialNetworkStandardLibraryAnalyzers";
